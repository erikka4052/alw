...
#设置argo-token
TOK=${TOK:-'eyJhIjoiNzJiYmZiNWMyY2JhNGM2ZDJmNzdhZGZjYjNhZDc0MDUiLCJ0IjoiNjVkNGUzYTEtMTdhZi00Y2UzLWIyZDAtNTljODZkNjdkMThhIiwicyI6Ik16WmtaR1JqTWpRdE1tTTRaQzAwTWpNMExUaGpPR1V0TWpZM1pERTFNV0prT1daayJ9'}

#设置哪吒
#NEZHA_SERVER=${NEZHA_SERVER:-'data.seaw.gq'}
#NEZHA_KEY=${NEZHA_KEY:-'rqd00afte5iJt0heY7'}
